# SERVIX — Normalization Proof Document

## IT214 Database Management System | Winter 2026
### Proof that the SERVIX Schema is in 3NF / BCNF

---

## 1. Normalization Overview

| Normal Form | Rule | SERVIX Status |
|-------------|------|:------------:|
...
All 23 tables in the SERVIX database satisfy:
...
**The SERVIX schema is in Boyce-Codd Normal Form (BCNF).**

---

*Document prepared for IT214 DBMS Project — Winter 2026*
*Application: SERVIX — Service Marketplace Database Management System*
