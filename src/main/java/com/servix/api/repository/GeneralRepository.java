...
public class GeneralRepository {
    ...
    public List<Map<String, Object>> getAllServices(int limit, int offset) {
    ...
    public List<Map<String, Object>> searchProviders(String keyword, int limit, int offset) {
        return jdbc.queryForList("""
    ...
    public List<Map<String, Object>> getAvailableProviders(String day, int limit, int offset) {
        return jdbc.queryForList("""
