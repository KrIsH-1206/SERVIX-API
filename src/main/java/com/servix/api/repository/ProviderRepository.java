...
public class ProviderRepository {
    ...
    public List<Map<String, Object>> getPendingJobs(int providerId, int limit, int offset) {
    ...
    // ── Completed Jobs ──────────────────────────────────────
    public List<Map<String, Object>> getCompletedJobs(int providerId, int limit, int offset) {
        return jdbc.queryForList("""
                SELECT b.booking_id, cu.name AS customer, b.scheduled_date,
    ...
    // ── Reviews & Ratings ───────────────────────────────────
    public List<Map<String, Object>> getReviews(int providerId, int limit, int offset) {
        return jdbc.queryForList("""
