...
public class BookingActionController {
    ...
    private final BookingActionService service;

    public BookingActionController(BookingActionService service) {
    ...
    public ResponseEntity<Map<String, Object>> cancelBooking(
        ...
        return ResponseEntity.ok(service.cancelBooking(id, reason));
    }
